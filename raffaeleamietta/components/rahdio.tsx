import {
  ...
  const title = "Rahdio - A city music synthesizer";
  ...
  const cardCover = "/images/project-cover/rahdio-cover.png"
  const field = "Data sonification";
  ...
  const role = "Developer, UI Designer";
  const jobType = "Personal"
