...
const title = "Interactive CX Map";
const description = `Design and prototype for an interactive Customer Experience map, that allows the client to monitor the performance of their customer journey live, and take rapid action.`;
const cardCover = "/images/project-cover/cxmap-cover.png"
const field = "UX/UI";

const client = "@" + "BCG Platinion";
const year = "2022";

const coverImage = "/images/project-banners/watchanalytics.png";

const role = "UX/UI Designer";
const jobType = "Professional"

const InteractiveCxMap = () => {
  return (
    <div className="py-2">
      <Dialog>
...
export default InteractiveCxMap;