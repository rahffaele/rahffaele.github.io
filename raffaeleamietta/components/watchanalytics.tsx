...
const title = "Watchanalytics platform UI/UX Design";
const description = `Complete redesign of watchanalytics.io interface, with improved architecture of information, visual
hierarchy and interactions for a seamless experience.`;
const cardCover = "/images/project-cover/watchanalytics-cover.png"
const field = "UX/UI";

const client = "@" + "Watchanalytics";
const year = "2023";
